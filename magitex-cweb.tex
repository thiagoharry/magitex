...
%                               REGISTRADORES                                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\countdef\parte&=18 \parte&=0
\countdef\capitulo&=19 \capitulo&=0
\countdef\secao&=20 \secao&=0
\countdef\subsecao&=21 \subsecao&=0
\countdef\ss&=22 \ss&=0
\countdef\sss&=23 \sss&=0
\countdef\ssss&=24 \ssss&=0
\countdef\sssss&=25 \sssss&=0
\countdef\ssssss&=26 \ssssss&=0
\countdef\sssssss&=27 \sssssss&=0
\countdef\ssssssss&=28 \ssssssss&=0
\countdef\aux&=29 \aux&=0
...
\gdef|{\gdef|{\fimsh&@alinhanormal@catcode`\\=0@gdef@cm&{0}@gdef@c&{0} }%
       \alinhaverbatim\gdef\c&{1}\catcode`\\=12@gdef@cm&{1}\iniciosh&}
...
@everypar{%
  ...
  @fi%
  @hbox{@cor{0.92 0.92 0.92}{@vrule height 2ex width @hsize depth @maxdepth}}%
  @hskip-@hsize@tentt&@sh&%
  }%
  @if@cm& 0%
    @catcode`|=11%
  @fi%
