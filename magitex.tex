...
\def\espacinho{\vskip3pt plus 1pt minus 1pt}
\def\espaco{\vskip6pt plus 2pt minus 2pt}
\def\espacao{\vskip12pt plus 4pt minus 4pt}
...
\def\offinterlineskip{\baselineskip-1000pt
  \lineskip\z@ \lineskiplimit16383.99999pt} % Dimensão máxima
...
\def\bordermatrix#1{\begingroup \m@th
  \setbox\z@\vbox{\def\cr{\crcr\noalign{\kern2pt\global\let\cr\endline}}%
    \ialign{$##$\hfil\kern2pt\kern\p@renwd&\espacinho\hfil$##$\hfil
      &&\quad\hfil$##$\hfil\crcr
...
\def\loggingall{\tracingcommands2\tracingstats2
  ...
  \showboxbreadth16383.99999pt\showboxdepth16383.99999pt}%(max dimen)
\def\tracingall{\tracingonline1\loggingall}

\def\showhyphens#1{\setbox0\vbox{\parfillskip\z@skip\hsize16383.99999pt\tenrm@%(max
                                %dimen)
