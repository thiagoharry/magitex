...
\def\textindent#1{\indent\llap{#1\espacote}\ignorespaces}
...
\outer\def\proclaim #1. #2\par{\medbreak
  \noindent{\fam6\tenbf@#1.\espacote}{\fam5\tensl@#2\par}%
