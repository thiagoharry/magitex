...
\dimendef\p@=1 \p@=1pt % this saves macro space and time
\dimendef\z@=2 \z@=0pt % can be used both for 0pt and 0
\dimendef\jot=3 \jot=3pt
\dimendef\p@renwd=4
\dimendef\dimen@=5
\dimendef\dimen@i=6
\dimendef\dimen@ii=7
...
% Constantes usadas:
\lineskip1pt % Distância garantida entre palavras se limite for atingido
\baselineskip12pt % Distância ideal entre linhas 
\lineskiplimit0pt % Distância mínima entre palavras de linhas diferentes
...
% \newinsert, \newfam, and so on.
\outer\def\newlanguage{\alloc@9\language\chardef256}
...
\def\topglue{\prevdepth-1000pt\vglue-\topskip\vglue} % for top of page
...
\def\overrightarrow#1{\vbox{\m@th\ialign{##\crcr
      \rightarrowfill\crcr\noalign{\kern-\p@\prevdepth-1000pt}
      $\hfil\displaystyle{#1}\hfil$\crcr}}}
\def\overleftarrow#1{\vbox{\m@th\ialign{##\crcr
      \leftarrowfill\crcr\noalign{\kern-\p@\prevdepth-1000pt}
      $\hfil\displaystyle{#1}\hfil$\crcr}}}
\def\overbrace#1{\mathop{\vbox{\m@th\ialign{##\crcr\noalign{\kern3\p@}
      \downbracefill\crcr\noalign{\kern3\p@\prevdepth-1000pt}
...
\def\makeheadline{\vbox to\z@{\vskip-22.5\p@
  \hbox to\hsize{\vbox to8.5\p@{}\the\headline}\vss}\prevdepth-1000pt}
...
\def\pagecontents{\ifvoid\topins\else\unvbox\topins\fi
  \dimen@=\dp255 \unvbox255 % open up \box255
