...
% disposição:
\skipdef\centering=0 \centering=0pt plus 1000pt minus 1000pt
\skipdef\z@skip=1 \z@skip=0pt plus0pt minus0pt
\skipdef\skip@=2
% 253 reservado para inserção \topins@
% 254 reservado para inserção \footins@
...
\long\def\italico#1{\def\func{\catcode`*=2\ifcat\prox*[VAZIO]\else[N]\fi}\futurelet\prox\func}
