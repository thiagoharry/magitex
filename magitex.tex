...
\catcode`\^^c3=13
\def^^c3#1{\ifx#1^^80\`A\else\ifx#1^^81{\accent19A}% Á
        \else\ifx#1^^82\^A\else\ifx#1^^83\~A%
  \else\ifx#1^^84\"A\else\ifx#1^^85\AA{}\else\ifx#1^^86\AE{}\else\ifx#1^^87%
  \c C{}\else\ifx#1^^88\`E\else\ifx#1^^89{\accent19E}% É
  \else\ifx#1^^8a\^E\else\ifx#1^^8b%
  \"E\else\ifx#1^^8c\`I\else\ifx#1^^8d{\accent19I}% Í
  \else\ifx#1^^8e\^I\else\ifx#1^^8f\"I%
  \else\ifx#1^^91\~N\else\ifx#1^^92\`O\else\ifx#1^^93{\accent19O}% Ó
  \else\ifx#1^^94\^O%
  \else\ifx#1^^95\~O\else\ifx#1^^96\"O\else\ifx#1^^98\O{}\else\ifx#1^^99\`U%
  \else\ifx#1^^9a{\accent19U}% Ú
  \else\ifx#1^^9b\^U\else\ifx#1^^9c\"U\else\ifx#1^^9d{\accent19Y}% Ý
  \else\ifx#1^^a0\`a\else\ifx#1^^a1{\accent19a}% á
  \else\ifx#1^^a2\^a\else\ifx#1^^a3\~a%
  \else\ifx#1^^a4\"a\else\ifx#1^^a5\aa{}\else\ifx#1^^a6\ae{}%
  \else\ifx#1^^a7\c c\else\ifx#1^^a8\`e\else\ifx#1^^a9{\accent19e}% é
  \else\ifx#1^^aa\^e%
  \else\ifx#1^^ab\"e\else\ifx#1^^ac\`i\else\ifx#1^^ad{\accent19\i}%
  \else\ifx#1^^ae\^\i{}%
  \else\ifx#1^^af\"\i{}\else\ifx#1^^b1\~n\else\ifx#1^^b2\`o\else\ifx#1^^b3{\accent19o}% ó
  \else\ifx#1^^b4\^o\else\ifx#1^^b5\~o\else\ifx#1^^b6\"o\else\ifx#1^^b8\o{}%
  \else\ifx#1^^b9\`u\else\ifx#1^^ba{\accent19u}% ú
