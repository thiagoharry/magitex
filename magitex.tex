...
\def^^c3#1{\ifx#1^^80{\accent18A}% À
  ...
  \else\ifx#1^^8f\"I%
  \else\ifx#1^^91\~N\else\ifx#1^^92{\accent18O}% Ò
  \else\ifx#1^^93{\accent19O}% Ó
  \else\ifx#1^^94{\accent94O}% Ô
  \else\ifx#1^^95\~O\else\ifx#1^^96\"O\else\ifx#1^^98\O{}\else\ifx#1^^99{\accent18U}% Ù
  ...
  \else\ifx#1^^af\"\i{}\else\ifx#1^^b1\~n\else\ifx#1^^b2{\accent18o}% ò
  \else\ifx#1^^b3{\accent19o}% ó
  \else\ifx#1^^b4{\accent94o}% ô
  \else\ifx#1^^b5\~o\else\ifx#1^^b6\"o\else\ifx#1^^b8\o{}%
