...
% ocorre com aspas e fechamento de colchetes.
...
\catcode`\^^c3=13
\def^^c3#1{\ifx#1^^80{\accent18A}% À
        \else\ifx#1^^81{\accent19A}% Á
        \else\ifx#1^^82{\accent94A}% Â
        \else\ifx#1^^83{\accent"7EA}% Ã
        \else\ifx#1^^84{\accent"7FA}% Ä
        \else\ifx#1^^85\AA{}\else\ifx#1^^86\AE{}\else\ifx#1^^87%
  \c C{}\else\ifx#1^^88{\accent18E}%
  \else\ifx#1^^89{\accent19E}% É
  \else\ifx#1^^8a{\accent94E}% Ê
  \else\ifx#1^^8b{\accent"7FE}% Ë
  \else\ifx#1^^8c{\accent18I}% Ì
  \else\ifx#1^^8d{\accent19I}% Í
  \else\ifx#1^^8e{\accent94I}% Î
  \else\ifx#1^^8f{\accent"7FI}% Ï
  \else\ifx#1^^91{\accent"7EN}% Ñ
  \else\ifx#1^^92{\accent18O}% Ò
  \else\ifx#1^^93{\accent19O}% Ó
  \else\ifx#1^^94{\accent94O}% Ô
  \else\ifx#1^^95{\accent"7EO}% Õ
  \else\ifx#1^^96{\accent"7FO}% Ö
  \else\ifx#1^^98\O{}\else\ifx#1^^99{\accent18U}% Ù
  \else\ifx#1^^9a{\accent19U}% Ú
  \else\ifx#1^^9b{\accent94U}% Û
  \else\ifx#1^^9c{\accent"7FU}% Ü
  \else\ifx#1^^9d{\accent19Y}% Ý
  \else\ifx#1^^a0{\accent18a}% à
  \else\ifx#1^^a1{\accent19a}% á
  \else\ifx#1^^a2{\accent94a}% â
  \else\ifx#1^^a3{\accent"7Ea}% ã
  \else\ifx#1^^a4{\accent"7Fa}% ä
  \else\ifx#1^^a5\aa{}\else\ifx#1^^a6\ae{}%
  \else\ifx#1^^a7\c c\else\ifx#1^^a8{\accent18e}% è
  \else\ifx#1^^a9{\accent19e}% é
  \else\ifx#1^^aa{\accent94e}% ê
  \else\ifx#1^^ab{\accent"7Fe}% ë
  \else\ifx#1^^ac{\accent18\i}% ì
  \else\ifx#1^^ad{\accent19\i}% í
  \else\ifx#1^^ae{\accent94\i}% î
  \else\ifx#1^^af{\accent"7F\i}% ï
  \else\ifx#1^^b1{\accent"7En}% ñ
  \else\ifx#1^^b2{\accent18o}% ò
  \else\ifx#1^^b3{\accent19o}% ó
  \else\ifx#1^^b4{\accent94o}% ô
  \else\ifx#1^^b5{\accent"7Eo}% õ
  \else\ifx#1^^b6{\accent"7Fo}% ö
  \else\ifx#1^^b8\o{}%
  \else\ifx#1^^b9{\accent18u}% ù
  \else\ifx#1^^ba{\accent19u}% ú
  \else\ifx#1^^bb{\accent94u}% û
  \else\ifx#1^^bc{\accent"7Fu}% ü
  \else\ifx#1^^bd{\accent19y}% ý
  \else\ifx#1^^bf{\accent"7FY}% ÿ
...
\def\espacinho{\kern .16667em } % Equivalente ao \thinspace do Plain TeX
...
% Comandos de estilo de escrita. TODO: Aplicar correção itálica
% condicionalmente
\def\italico#1{{\fam4\tenit@ #1\/}}
\def\romano#1{{\fam0\tenrm@ #1}}
\def\negrito#1{{\fam6\tenbf@ #1}}
\def\inclinado#1{{\fam5\tensl@ #1\/}}
\def\monoespaco#1{{\fam7\tentt@ #1}}
...
\newfam\itfam \def\it{\fam4\tenit@} % \it is family 4
\textfont\itfam=\tenit@
\newfam\slfam \def\sl{\fam5\tensl@} % \sl is family 5
\textfont\slfam=\tensl@
\newfam\bffam \def\bf{\fam6\tenbf@} % \bf is family 6
\textfont\bffam=\tenbf@ \scriptfont\bffam=\sevenbf
\scriptscriptfont\bffam=\fivebf
\newfam\ttfam \def\tt{\fam7\tentt@} % \tt is family 7
\textfont\ttfam=\tentt@
