...
\def\bordermatrix#1{\begingroup \m@th
  ...
  \setbox\tw@\vbox{\unvcopy\z@\global\setbox1\lastbox}%
  \setbox\tw@\hbox{\unhbox1\unskip\global\setbox1\lastbox}%
  \setbox\tw@\hbox{$\kern\wd1\kern-\p@renwd\left(\kern-\wd1
    \global\setbox1\vbox{\box1\kern2\p@}%
    \vcenter{\kern-\ht1\unvbox\z@\kern-\baselineskip}\,\right)$}%
  \null\;\vbox{\kern\ht1\box\tw@}\endgroup}
...
\def\loggingall{\tracingcommands\tw@\tracingstats\tw@
  ...
  \tracingmacros\tw@\tracingparagraphs1\tracingrestores1
