...
\def^^c3#1{\ifx#1^^80{\accent18A}% À
  ...
  \else\ifx#1^^9b\^U\else\ifx#1^^9c\"U\else\ifx#1^^9d{\accent19Y}% Ý
  \else\ifx#1^^a0{\accent18a}% à
  \else\ifx#1^^a1{\accent19a}% á
  \else\ifx#1^^a2\^a\else\ifx#1^^a3\~a%
  ...
  \else\ifx#1^^b4\^o\else\ifx#1^^b5\~o\else\ifx#1^^b6\"o\else\ifx#1^^b8\o{}%
  \else\ifx#1^^b9{\accent18u}% ù
  \else\ifx#1^^ba{\accent19u}% ú
  \else\ifx#1^^bb\^u\else\ifx#1^^bc\"u%
