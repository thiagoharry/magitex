...
\def^^c3#1{\ifx#1^^80{\accent18A}% À
        ...
        \else\ifx#1^^85\AA{}
  \else\ifx#1^^86\char"1D
  \else\ifx#1^^87\c C{} % TODO
  \else\ifx#1^^88{\accent18E}%
  ...
  \else\ifx#1^^98\char"1F% \O
  \else\ifx#1^^99{\accent18U}% Ù
  ...
  \else\ifx#1^^a5\aa{}\else\ifx#1^^a6\char"1A%
